package com.fiap.shift.ms.mskafka;
...
import com.fiap.shift.ms.mskafka.model.Greeting;

@SpringBootApplication
public class MsKafkaApplication {

	public static void main(String[] args) throws InterruptedException {
		ConfigurableApplicationContext context = SpringApplication.run(MsKafkaApplication.class, args);
		MessageProducer producer = context.getBean(MessageProducer.class);
        MessageListener listener = context.getBean(MessageListener.class);
        /* Manda um Hello World para o topico cristiano 
         * a mensagem sera recebida pelos 2 listeners . 
    ...
    public static class MessageProducer {
        ...
        public void sendMessageToPartion(String message, int partition) {
            kafkaTemplate.send(partionedTopicName, message);
        }
