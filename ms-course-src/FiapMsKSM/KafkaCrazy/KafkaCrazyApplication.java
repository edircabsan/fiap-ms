package com.fiap.shift.ms.kafkaCrazy;
...
public class KafkaCrazyApplication {

	public static void main(String[] args) throws InterruptedException {
		ConfigurableApplicationContext context = SpringApplication.run(KafkaCrazyApplication.class, args);
